...
from digikey.v3.productinformation.models.api_error_response import ApiErrorResponse  # noqa: E501
...
class TestApiErrorResponse(unittest.TestCase):
    ...
    def testApiErrorResponse(self):
        ...
        # model = digikey.v3.productinformation.models.api_error_response.ApiErrorResponse()  # noqa: E501
        pass
