...
from digikey.v3.productinformation.models.sort_parameters import SortParameters  # noqa: E501
...
class TestSortParameters(unittest.TestCase):
    ...
    def testSortParameters(self):
        ...
        # model = digikey.v3.productinformation.models.sort_parameters.SortParameters()  # noqa: E501
        pass
